# Generated by Django 5.2 on 2025-05-30 07:12
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bachelor_college', models.CharField(blank=True, max_length=135, verbose_name='本科院校')),
                ('master_college', models.CharField(blank=True, max_length=135, verbose_name='硕士院校')),
                ('doctor_college', models.CharField(blank=True, max_length=135, verbose_name='博士院校')),
                ...
                ('first_professional_competency', models.DecimalField(blank=True, decimal_places=1, max_digits=2, null=True, verbose_name='初试结果')),
                ('first_advantage', models.TextField(blank=True, max_length=1024, verbose_name='优势')),
                ('first_disadvantage', models.TextField(blank=True, max_length=1024, verbose_name='顾虑及不足')),
                ('first_result', models.CharField(blank=True, choices=[('建议复试', '建议复试'), ('待定', '待定'), ('放弃', '放弃')], max_length=256, verbose_name='初试结果')),
                ('first_recommend_department', models.CharField(blank=True, max_length=256, verbose_name='推荐部门')),
                ...
                ('second_professional_ability', models.DecimalField(blank=True, decimal_places=1, max_digits=2, null=True, verbose_name='专业能力得分')),
                ('second_pursuit_of_excellence_ability', models.DecimalField(blank=True, decimal_places=1, max_digits=2, null=True, verbose_name='追求卓越得分')),
                ('second_communication_ability', models.DecimalField(blank=True, decimal_places=1, max_digits=2, null=True, verbose_name='沟通能力得分')),
                ('second_anti_pressure_ability', models.DecimalField(blank=True, decimal_places=1, max_digits=2, null=True, verbose_name='抗压能力得分')),
                ('second_advantage', models.TextField(blank=True, max_length=1024, verbose_name='优势')),
                ('second_disadvantage', models.TextField(blank=True, max_length=1024, verbose_name='顾虑及不足')),
                ('second_result', models.CharField(blank=True, choices=[('建议录用', '建议录用'), ('待定', '待定'), ('放弃', '放弃')], max_length=256, verbose_name='专业复试结果')),
                ('second_recommend_department', models.CharField(blank=True, max_length=256, verbose_name='建议方向或推荐部门')),
                ...
                ('hr_score', models.CharField(blank=True, choices=[('S', 'S（优秀）'), ('A', 'A（良好）'), ('B', 'B（合格）'), ('C', 'C（待改进）')], max_length=10, verbose_name='HR复试综合等级')),
                ('hr_responsibility', models.CharField(blank=True, choices=[('S', 'S（优秀）'), ('A', 'A（良好）'), ('B', 'B（合格）'), ('C', 'C（待改进）')], max_length=10, verbose_name='HR责任心')),
                ('hr_communication_ability', models.CharField(blank=True, choices=[('S', 'S（优秀）'), ('A', 'A（良好）'), ('B', 'B（合格）'), ('C', 'C（待改进）')], max_length=10, verbose_name='HR坦诚沟通')),
                ('hr_logic_ability', models.CharField(blank=True, choices=[('S', 'S（优秀）'), ('A', 'A（良好）'), ('B', 'B（合格）'), ('C', 'C（待改进）')], max_length=10, verbose_name='HR逻辑思维')),
                ('hr_potential', models.CharField(blank=True, choices=[('S', 'S（优秀）'), ('A', 'A（良好）'), ('B', 'B（合格）'), ('C', 'C（待改进）')], max_length=10, verbose_name='HR发展潜力')),
                ('hr_stability', models.CharField(blank=True, choices=[('S', 'S（优秀）'), ('A', 'A（良好）'), ('B', 'B（合格）'), ('C', 'C（待改进）')], max_length=10, verbose_name='HR稳定性')),
                ('hr_advantage', models.TextField(blank=True, max_length=1024, verbose_name='优势')),
                ('hr_disadvantage', models.TextField(blank=True, max_length=1024, verbose_name='顾虑及不足')),
